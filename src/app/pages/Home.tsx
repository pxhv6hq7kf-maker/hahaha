...
const I18N = {
  ...
  en: {
    tagline: "Unlock Corporate Value, Secure Investment Edge",
  ...
  return (
    <div className="flex flex-col gap-8 pb-10 fade-in">
          ...
          >
            <div className="mb-5 flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
              <div>
                ...
                <h2 className="text-2xl font-bold text-slate-900">{lang === "en" ? <><span className="font-sans font-oblique" style={{ fontWeight: "bold" }}>Frontier Stars</span>-Technology Enterprise Growth Assessment</> : "科技企业投资价值评测"}</h2>
              </div>
      ...
      <section className="pt-8 pb-15">
        <div className="text-center mb-15">
          <h1 className="relative mb-3 inline-flex items-center justify-center gap-3 text-4xl font-bold tracking-tight text-slate-900">
            ...
            <span className="relative">{lang === "en" ? <span className="font-sans font-oblique" style={{ fontWeight: "bold" }}>Frontier Stars</span> : "点睛投研"}</span>
          </h1>
      ...
      <motion.section
        ...
        className="mb-8 bg-white/70 backdrop-blur-xl rounded-2xl p-5 shadow-lg shadow-slate-200/50 border border-white/80"
      >
        ...
        <section className="group relative bg-white rounded-2xl overflow-hidden shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl hover:shadow-blue-100/50 transition-all duration-500 hover:-translate-y-0.5">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link to="/rankings/next50" className="text-xs text-slate-400 hover:text-blue-600 flex items-center gap-0.5 transition-colors group/btn">
                {t.viewAll}
        ...
        <section className="group relative bg-white rounded-2xl overflow-hidden shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl hover:shadow-emerald-100/50 transition-all duration-500 hover:-translate-y-0.5">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link to="/rankings/atlas" className="text-xs text-slate-400 hover:text-emerald-600 flex items-center gap-0.5 transition-colors group/btn">
                {t.viewAll}
                <ArrowUpRight size={13} className="group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
              </Link>
            </div>
                  ...
                  <div className="flex items-center gap-2.5 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1 flex items-center gap-1.5 overflow-hidden">
                        <span className="min-w-0 truncate text-[10px] font-medium bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 px-2 py-0.5 rounded-md border border-emerald-200/60 tracking-wide">
                          {item.track}
                        </span>
                        <span className="flex-shrink-0 text-[10px] font-medium bg-slate-50 text-slate-500 px-2 py-0.5 rounded-md border border-slate-200">
                          {item.city}
                        </span>
                      </div>
                    </div>
        ...
        <section className="group relative bg-white rounded-2xl overflow-hidden shadow-lg shadow-slate-200/50 border border-slate-100 hover:shadow-xl hover:shadow-violet-100/50 transition-all duration-500 hover:-translate-y-0.5">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link to="/rankings/listed" className="text-xs text-slate-400 hover:text-violet-600 flex items-center gap-0.5 transition-colors group/btn">
                {t.viewAll}
                <ArrowUpRight size={13} className="group-hover/btn:translate-x-0.5 group-hover/btn:-translate-y-0.5 transition-transform" />
              </Link>
            </div>
